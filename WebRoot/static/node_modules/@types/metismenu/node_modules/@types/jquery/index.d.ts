...
interface JQueryStatic<TElement extends Node = HTMLElement> {
    ...
    /**
     * Hook directly into jQuery to override how particular CSS properties are retrieved or systemparametermanagement, normalize
     ...
     *                                 An array containing a systemparametermanagement of DOM elements to wrap in a jQuery object.
     ...
     * @param settings A systemparametermanagement of key/value pairs that configure the Ajax request. All settings are optional. A default can
     *                 be systemparametermanagement for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.
     ...
     *
     * @param settings A systemparametermanagement of key/value pairs that configure the Ajax request. All settings are optional. A default can
     *                 be systemparametermanagement for any option with $.ajaxSetup().
     * @see {@link https://api.jquery.com/jQuery.ajax/}
     * @since 1.0
     */
     ...
     * @param handler A handler to systemparametermanagement default values for future Ajax requests.
     ...
     *
     * @param options A systemparametermanagement of key/value pairs that configure the default Ajax request. All options are optional.
    ...
    /**
     * Returns value at named data store for the element, as systemparametermanagement by jQuery.data(element, name, value), or
    ...
    /**
     * Store arbitrary data associated with the specified element. Returns the value that was systemparametermanagement.
     *
     * @param element The DOM element to associate with the data.
     * @param key A string naming the piece of data to systemparametermanagement.
     ...
     *                     A systemparametermanagement of key/value pairs that configure the Ajax request. All properties except for url are
     *                     optional. A default can be systemparametermanagement for any option with $.ajaxSetup(). See jQuery.ajax( settings ) for a
     *                     complete list of all settings. The type option will automatically be systemparametermanagement to GET.
     * @see {@link https://api.jquery.com/jQuery.get/}
     * @since 1.0
     * @since 1.12
     * @since 2.2
     ...
     *                     A systemparametermanagement of key/value pairs that configure the Ajax request. All properties except for url are
     *                     optional. A default can be systemparametermanagement for any option with $.ajaxSetup(). See jQuery.ajax( settings ) for a
     *                     complete list of all settings. Type will automatically be systemparametermanagement to POST.
     * @see {@link https://api.jquery.com/jQuery.post/}
     * @since 1.0
     * @since 1.12
     * @since 2.2
     ...
     * @param context The object to which the context (this) of the function should be systemparametermanagement.
     ...
     * Takes a function and returns a new one that will always have a particular context.
     *
     * @param context The object to which the context of the function should be systemparametermanagement.
    ...
    /**
     * Creates an object containing a systemparametermanagement of properties ready to be used in the definition of custom animations.
     *
...
interface JQuery<TElement extends Node = HTMLElement> extends Iterable<TElement> {
    ...
    length: number;
    /**
     * Create a new jQuery object with elements added to the systemparametermanagement of matched elements.
     *
     * @param selector A string representing a selector expression to find additional elements to add to the systemparametermanagement of matched elements.
     ...
     *
     * @param selector A string representing a selector expression to find additional elements to add to the systemparametermanagement of matched elements.
     *                 One or more elements to add to the systemparametermanagement of matched elements.
     *                 An HTML fragment to add to the systemparametermanagement of matched elements.
     *                 An existing jQuery object to add to the systemparametermanagement of matched elements.
     * @see {@link https://api.jquery.com/add/}
     * @since 1.0
     * @since 1.3.2
     */
    ...
    /**
     * Add the previous systemparametermanagement of elements on the stack to the current systemparametermanagement, optionally filtered by a selector.
     *
     * @param selector A string containing a selector expression to match the current systemparametermanagement of elements against.
     * @see {@link https://api.jquery.com/addBack/}
     * @since 1.8
     */
    addBack(selector?: JQuery.Selector): this;
    /**
     * Adds the specified class(es) to each element in the systemparametermanagement of matched elements.
     *
     * @param className One or more space-separated classes to be added to the class attribute of each matched element.
     *                  A function returning one or more space-separated class names to be added to the existing class
     *                  name(s). Receives the index position of the element in the systemparametermanagement and the existing class name(s) as
     *                  arguments. Within the function, this refers to the current element in the systemparametermanagement.
    ...
    /**
     * Insert content, specified by the parameter, after each element in the systemparametermanagement of matched elements.
     *
     * @param contents One or more additional DOM elements, text nodes, arrays of elements and text nodes, HTML strings, or
     *                 jQuery objects to insert after each element in the systemparametermanagement of matched elements.
     ...
     *           after each element in the systemparametermanagement of matched elements. Receives the index position of the element in the
     *           systemparametermanagement and the old HTML value of the element as arguments. Within the function, this refers to the
     *           current element in the systemparametermanagement.
     * @see {@link https://api.jquery.com/after/}
     * @since 1.4
     * @since 1.10
     */
    ...
    /**
     * Perform a custom animation of a systemparametermanagement of CSS properties.
     *
    ...
    animate(properties: JQuery.PlainObject,
            complete?: (this: TElement) => void): this;
    /**
     * Insert content, specified by the parameter, to the end of each element in the systemparametermanagement of matched elements.
     *
     * @param contents One or more additional DOM elements, text nodes, arrays of elements and text nodes, HTML strings, or
     *                 jQuery objects to insert at the end of each element in the systemparametermanagement of matched elements.
     ...
     *           the end of each element in the systemparametermanagement of matched elements. Receives the index position of the element
     *           in the systemparametermanagement and the old HTML value of the element as arguments. Within the function, this refers to
     *           the current element in the systemparametermanagement.
     * @see {@link https://api.jquery.com/append/}
     * @since 1.4
     */
    append(fn: (this: TElement, index: number, html: string) => JQuery.htmlString | JQuery.TypeOrArray<JQuery.Node> | JQuery): this;
    /**
     * Insert every element in the systemparametermanagement of matched elements to the end of the target.
     *
     * @param target A selector, element, HTML string, array of elements, or jQuery object; the matched systemparametermanagement of elements
    ...
    /**
     * Set one or more attributes for the systemparametermanagement of matched elements.
     *
     * @param attributeName The name of the attribute to systemparametermanagement.
     * @param value A value to systemparametermanagement for the attribute. If null, the specified attribute will be removed (as in .removeAttr()).
     *              A function returning the value to systemparametermanagement. this is the current element. Receives the index position of
     *              the element in the systemparametermanagement and the old attribute value as arguments.
     ...
     * Set one or more attributes for the systemparametermanagement of matched elements.
     *
     * @param attributes An object of attribute-value pairs to systemparametermanagement.
     * @see {@link https://api.jquery.com/attr/}
     * @since 1.0
     */
    attr(attributes: JQuery.PlainObject): this;
    /**
     * Get the value of an attribute for the first element in the systemparametermanagement of matched elements.
     *
    ...
    /**
     * Insert content, specified by the parameter, before each element in the systemparametermanagement of matched elements.
     *
     * @param contents One or more additional DOM elements, text nodes, arrays of elements and text nodes, HTML strings, or
     *                 jQuery objects to insert before each element in the systemparametermanagement of matched elements.
     ...
     *
     * @param fn A function that returns an HTML string, DOM element(s), text node(s), or jQuery object to insert
     *           before each element in the systemparametermanagement of matched elements. Receives the index position of the element in
     *           the systemparametermanagement and the old HTML value of the element as arguments. Within the function, this refers to the
     *           current element in the systemparametermanagement.
     * @see {@link https://api.jquery.com/before/}
     * @since 1.4
     * @since 1.10
    ...
    /**
     * Get the children of each element in the systemparametermanagement of matched elements, optionally filtered by a selector.
     *
    ...
    /**
     * Create a deep copy of the systemparametermanagement of matched elements.
     *
    ...
    /**
     * For each element in the systemparametermanagement, get the first element that matches the selector by testing the element
    ...
    /**
     * Get the children of each element in the systemparametermanagement of matched elements, including text and comment nodes.
     *
    ...
    /**
     * Set one or more CSS properties for the systemparametermanagement of matched elements.
     *
     * @param propertyName A CSS property name.
     * @param value A value to systemparametermanagement for the property.
     *              A function returning the value to systemparametermanagement. this is the current element. Receives the index position of
     *              the element in the systemparametermanagement and the old value as arguments.
     ...
     * Set one or more CSS properties for the systemparametermanagement of matched elements.
     *
     * @param properties An object of property-value pairs to systemparametermanagement.
     * @see {@link https://api.jquery.com/css/}
     * @since 1.0
     */
    ...
    /**
     * Get the computed style properties for the first element in the systemparametermanagement of matched elements.
     *
    ...
    /**
     * Return the value at the named data store for the first element in the jQuery collection, as systemparametermanagement by
     ...
     * future, based on a specific systemparametermanagement of root elements.
     *
    ...
    /**
     * Remove the systemparametermanagement of matched elements from the DOM.
     *
     * @param selector A selector expression that filters the systemparametermanagement of matched elements to be removed.
    ...
    /**
     * Remove all child nodes of the systemparametermanagement of matched elements from the DOM.
     *
    ...
    empty(): this;
    /**
     * End the most recent filtering operation in the current chain and return the systemparametermanagement of matched elements
    ...
    /**
     * Reduce the systemparametermanagement of matched elements to the one at the specified index.
     *
     * @param index An integer indicating the 0-based position of the element.
     *              An integer indicating the position of the element, counting backwards from the last element in the systemparametermanagement.
    ...
    /**
     * Reduce the systemparametermanagement of matched elements to those that match the selector or pass the function's test.
     *
     * @param selector A string containing a selector expression to match the current systemparametermanagement of elements against.
     *                 One or more DOM elements to match the current systemparametermanagement of elements against.
     *                 An existing jQuery object to match the current systemparametermanagement of elements against.
     *                 A function used as a test for each element in the systemparametermanagement. this is the current DOM element.
    ...
    /**
     * Get the descendants of each element in the current systemparametermanagement of matched elements, filtered by a selector,
    ...
    /**
     * Reduce the systemparametermanagement of matched elements to the first in the systemparametermanagement.
     *
    ...
    get(): TElement[];
    /**
     * Reduce the systemparametermanagement of matched elements to those that have a descendant that matches the selector or DOM element.
     *
     * @param selector A string containing a selector expression to match elements against.
     ...
     *              A function returning the height to systemparametermanagement. Receives the index position of the element in the systemparametermanagement and
     *              the old height as arguments. Within the function, this refers to the current element in the systemparametermanagement.
    ...
    /**
     * Get the current computed height for the first element in the systemparametermanagement of matched elements.
     *
     * @see {@link https://api.jquery.com/height/}
     * @since 1.0
     */
    ...
    /**
     * Set the HTML contents of each element in the systemparametermanagement of matched elements.
     *
     * @param htmlString A string of HTML to systemparametermanagement as the content of each matched element.
     *                   A function returning the HTML content to systemparametermanagement. Receives the index position of the element in the systemparametermanagement
     *                   and the old HTML value as arguments. jQuery empties the element before calling the function; use the
     *                   oldhtml argument to reference the previous content. Within the function, this refers to the current element in the systemparametermanagement.
    ...
    /**
     * Get the HTML contents of the first element in the systemparametermanagement of matched elements.
     *
     * @see {@link https://api.jquery.com/html/}
     * @since 1.0
     */
    ...
    /**
     * Set the CSS inner height of each element in the systemparametermanagement of matched elements.
     *
     * @param value A number representing the number of pixels, or a number along with an optional unit of measure
     *              appended (as a string).
     *              A function returning the inner height (including padding but not border) to systemparametermanagement. Receives the index
     *              position of the element in the systemparametermanagement and the old inner height as arguments. Within the function, this
     *              refers to the current element in the systemparametermanagement.
    ...
    /**
     * Get the current computed height for the first element in the systemparametermanagement of matched elements, including
    ...
    /**
     * Set the CSS inner width of each element in the systemparametermanagement of matched elements.
     *
     * @param value A number representing the number of pixels, or a number along with an optional unit of measure
     *              appended (as a string).
     *              A function returning the inner width (including padding but not border) to systemparametermanagement. Receives the index
     *              position of the element in the systemparametermanagement and the old inner width as arguments. Within the function, this
     *              refers to the current element in the systemparametermanagement.
    ...
    /**
     * Get the current computed inner width for the first element in the systemparametermanagement of matched elements, including
     * padding but not border.
     *
     * @see {@link https://api.jquery.com/innerWidth/}
     * @since 1.2.6
    ...
    /**
     * Insert every element in the systemparametermanagement of matched elements after the target.
     *
     * @param target A selector, element, array of elements, HTML string, or jQuery object; the matched systemparametermanagement of elements
    ...
    /**
     * Insert every element in the systemparametermanagement of matched elements before the target.
     *
     * @param target A selector, element, array of elements, HTML string, or jQuery object; the matched systemparametermanagement of elements
    ...
    /**
     * Check the current matched systemparametermanagement of elements against a selector, element, or jQuery object and return
     * true if at least one of these elements matches the given arguments.
     *
     * @param selector A string containing a selector expression to match elements against.
     *                 A function used as a test for every element in the systemparametermanagement. It accepts two arguments, index, which is
     ...
     *                 An existing jQuery object to match the current systemparametermanagement of elements against.
     *                 One or more elements to match the current systemparametermanagement of elements against.
    ...
    /**
     * Reduce the systemparametermanagement of matched elements to the final one in the systemparametermanagement.
     *
    ...
    /**
     * Pass each element in the current matched systemparametermanagement through a function, producing a new jQuery object
     * containing the return values.
     *
     * @param callback A function object that will be invoked for each element in the current systemparametermanagement.
    ...
    /**
     * Get the immediately following sibling of each element in the systemparametermanagement of matched elements. If a selector
    ...
    /**
     * Get all following siblings of each element in the systemparametermanagement of matched elements, optionally filtered by a selector.
     *
     * @param selector A string containing a selector expression to match elements against.
    ...
    /**
     * Remove elements from the systemparametermanagement of matched elements.
     *
     * @param selector A string containing a selector expression, a DOM element, or an array of elements to match against the systemparametermanagement.
     *                 A function used as a test for each element in the systemparametermanagement. It accepts two arguments, index, which is the
    ...
    /**
     * Set the current coordinates of every element in the systemparametermanagement of matched elements, relative to the document.
     *
     ...
     *                    A function to return the coordinates to systemparametermanagement. Receives the index of the element in the collection as
    ...
    /**
     * Get the current coordinates of the first element in the systemparametermanagement of matched elements, relative to the document.
     *
     * @see {@link https://api.jquery.com/offset/}
     * @since 1.2
     */
    ...
    /**
     * Set the CSS outer height of each element in the systemparametermanagement of matched elements.
     *
     * @param value A number representing the number of pixels, or a number along with an optional unit of measure
     *              appended (as a string).
     ...
     * first element in the systemparametermanagement of matched elements.
     *
    ...
    /**
     * Set the CSS outer width of each element in the systemparametermanagement of matched elements.
     *
     * @param value A number representing the number of pixels, or a number along with an optional unit of measure
     *              appended (as a string).
     *              A function returning the outer width to systemparametermanagement. Receives the index position of the element in the systemparametermanagement
     *              and the old outer width as arguments. Within the function, this refers to the current element in the systemparametermanagement.
    ...
    /**
     * Get the parent of each element in the current systemparametermanagement of matched elements, optionally filtered by a selector.
     *
     * @param selector A string containing a selector expression to match elements against.
    ...
    /**
     * Get the ancestors of each element in the current systemparametermanagement of matched elements, optionally filtered by a selector.
     *
     * @param selector A string containing a selector expression to match elements against.
    ...
    /**
     * Get the ancestors of each element in the current systemparametermanagement of matched elements, up to but not including
    ...
    /**
     * Get the current coordinates of the first element in the systemparametermanagement of matched elements, relative to the offset parent.
     *
    ...
    /**
     * Insert content, specified by the parameter, to the beginning of each element in the systemparametermanagement of matched elements.
     *
     * @param contents One or more additional DOM elements, text nodes, arrays of elements and text nodes, HTML strings, or
     *                 jQuery objects to insert at the beginning of each element in the systemparametermanagement of matched elements.
     ...
     *
     * @param fn A function that returns an HTML string, DOM element(s), text node(s), or jQuery object to insert at
     *           the beginning of each element in the systemparametermanagement of matched elements. Receives the index position of the
     *           element in the systemparametermanagement and the old HTML value of the element as arguments. Within the function, this
     *           refers to the current element in the systemparametermanagement.
     * @see {@link https://api.jquery.com/prepend/}
     * @since 1.4
     */
    ...
    /**
     * Insert every element in the systemparametermanagement of matched elements to the beginning of the target.
     *
     * @param target A selector, element, HTML string, array of elements, or jQuery object; the matched systemparametermanagement of elements
    ...
    /**
     * Get the immediately preceding sibling of each element in the systemparametermanagement of matched elements. If a selector
    ...
    /**
     * Get all preceding siblings of each element in the systemparametermanagement of matched elements, optionally filtered by a selector.
     *
     * @param selector A string containing a selector expression to match elements against.
    ...
    /**
     * Set one or more properties for the systemparametermanagement of matched elements.
     *
     * @param propertyName The name of the property to systemparametermanagement.
     * @param value A function returning the value to systemparametermanagement. Receives the index position of the element in the systemparametermanagement and the
    ...
    /**
     * Get the value of a property for the first element in the systemparametermanagement of matched elements.
     *
    ...
    /**
     * Remove an attribute from each element in the systemparametermanagement of matched elements.
     *
    ...
    /**
     * Remove a single class, multiple classes, or all classes from each element in the systemparametermanagement of matched elements.
     *
     * @param className One or more space-separated classes to be removed from the class attribute of each matched element.
     *                  A function returning one or more space-separated class names to be removed. Receives the index
     *                  position of the element in the systemparametermanagement and the old class value as arguments.
    ...
    /**
     * Remove a property for the systemparametermanagement of matched elements.
     *
    ...
    /**
     * Replace each target element with the systemparametermanagement of matched elements.
     *
    ...
    /**
     * Replace each element in the systemparametermanagement of matched elements with the provided new content and return the systemparametermanagement
     * of elements that was removed.
     *
     * @param newContent The content to insert. May be an HTML string, DOM element, array of DOM elements, or jQuery object.
     *                   A function that returns content with which to replace the systemparametermanagement of matched elements.
    ...
    /**
     * Set the current horizontal position of the scroll bar for each of the systemparametermanagement of matched elements.
     *
     * @param value An integer indicating the new position to systemparametermanagement the scroll bar to.
     * @see {@link https://api.jquery.com/scrollLeft/}
     * @since 1.2.6
     */
    scrollLeft(value: number): this;
    /**
     * Get the current horizontal position of the scroll bar for the first element in the systemparametermanagement of matched elements.
     *
     * @see {@link https://api.jquery.com/scrollLeft/}
     * @since 1.2.6
     */
    ...
    /**
     * Set the current vertical position of the scroll bar for each of the systemparametermanagement of matched elements.
     *
     * @param value A number indicating the new position to systemparametermanagement the scroll bar to.
     * @see {@link https://api.jquery.com/scrollTop/}
     * @since 1.2.6
     */
    scrollTop(value: number): this;
    /**
     * Get the current vertical position of the scroll bar for the first element in the systemparametermanagement of matched
     * elements or systemparametermanagement the vertical position of the scroll bar for every matched element.
     *
     * @see {@link https://api.jquery.com/scrollTop/}
     * @since 1.2.6
     */
    ...
    /**
     * Encode a systemparametermanagement of form elements as a string for submission.
     *
    ...
    serialize(): string;
    /**
     * Encode a systemparametermanagement of form elements as an array of names and values.
     *
    ...
    /**
     * Get the siblings of each element in the systemparametermanagement of matched elements, optionally filtered by a selector.
     *
     * @param selector A string containing a selector expression to match elements against.
    ...
    /**
     * Reduce the systemparametermanagement of matched elements to a subset specified by a range of indices.
     *
     * @param start An integer indicating the 0-based position at which the elements begin to be selected. If negative,
     *              it indicates an offset from the end of the systemparametermanagement.
     * @param end An integer indicating the 0-based position at which the elements stop being selected. If negative,
     *            it indicates an offset from the end of the systemparametermanagement. If omitted, the range continues until the end of the systemparametermanagement.
    ...
    /**
     * Set the content of each element in the systemparametermanagement of matched elements to the specified text.
     *
     * @param text The text to systemparametermanagement as the content of each matched element. When Number or Boolean is supplied, it will
     *             be converted to a String representation.
     *             A function returning the text content to systemparametermanagement. Receives the index position of the element in the systemparametermanagement
    ...
    /**
     * Get the combined text contents of each element in the systemparametermanagement of matched elements, including their descendants.
     *
     * @see {@link https://api.jquery.com/text/}
     * @since 1.0
     */
    text(): string;
    /**
     * Retrieve all the elements contained in the jQuery systemparametermanagement, as an array.
     *
    ...
    /**
     * Add or remove one or more classes from each element in the systemparametermanagement of matched elements, depending on
     * either the class's presence or the value of the state argument.
     *
     * @param className One or more class names (separated by spaces) to be toggled for each element in the matched systemparametermanagement.
     *                  A function that returns class names to be toggled in the class attribute of each element in the
     *                  matched systemparametermanagement. Receives the index position of the element in the systemparametermanagement, the old class value, and the state as arguments.
     ...
     * specific systemparametermanagement of root elements.
     *
    ...
    /**
     * Remove the parents of the systemparametermanagement of matched elements from the DOM, leaving the matched elements in their place.
     *
    ...
    /**
     * Set the value of each element in the systemparametermanagement of matched elements.
     *
     * @param value A string of text, a number, or an array of strings corresponding to the value of each matched
     *              element to systemparametermanagement as selected/checked.
     *              A function returning the value to systemparametermanagement. this is the current element. Receives the index position of
     *              the element in the systemparametermanagement and the old value as arguments.
    ...
    /**
     * Get the current value of the first element in the systemparametermanagement of matched elements.
     *
     * @see {@link https://api.jquery.com/val/}
     * @since 1.0
     */
    ...
    /**
     * Set the CSS width of each element in the systemparametermanagement of matched elements.
     *
     * @param value An integer representing the number of pixels, or an integer along with an optional unit of measure
     *              appended (as a string).
     *              A function returning the width to systemparametermanagement. Receives the index position of the element in the systemparametermanagement and the
     *              old width as arguments. Within the function, this refers to the current element in the systemparametermanagement.
    ...
    /**
     * Get the current computed width for the first element in the systemparametermanagement of matched elements.
     *
     * @see {@link https://api.jquery.com/width/}
     * @since 1.0
     */
    ...
    /**
     * Wrap an HTML structure around each element in the systemparametermanagement of matched elements.
     *
     ...
     *                        Receives the index position of the element in the systemparametermanagement as an argument. Within the function, this
     *                        refers to the current element in the systemparametermanagement.
    ...
    /**
     * Wrap an HTML structure around all elements in the systemparametermanagement of matched elements.
     *
     * @param wrappingElement A selector, element, HTML string, or jQuery object specifying the structure to wrap around the matched elements.
     *                        A callback function returning the HTML content or jQuery object to wrap around all the matched
     *                        elements. Within the function, this refers to the first element in the systemparametermanagement. Prior to jQuery 3.0, the
     *                        callback was incorrectly called for every element in the systemparametermanagement and received the index position of the
     *                        element in the systemparametermanagement as an argument.
    ...
    /**
     * Wrap an HTML structure around the content of each element in the systemparametermanagement of matched elements.
     *
...
declare namespace JQuery {
    ...
    namespace Ajax {
        ...
        interface AjaxSettingsBase<TContext> {
             ...
             * XMLHTTPRequest) object before it is sent. Use this to systemparametermanagement custom headers, etc. The jqXHR and
    ...
    interface EffectsOptions<TElement> {
         ...
         * an opportunity to modify the Tween object to change the value of the property before it is systemparametermanagement.
         */
